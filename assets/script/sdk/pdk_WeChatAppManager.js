...
var pdk_WeChatAppManager = app.BaseClass.extend({
    Init:function() {
...
var g_pdk_WeChatAppManager = null;

/**
 * 绑定模块外部方法
 */
exports.GetModel = function(){
    if(!g_pdk_WeChatAppManager){
        g_pdk_WeChatAppManager = new pdk_WeChatAppManager();
    }
    return g_pdk_WeChatAppManager;
};
