...
var pdk_HotUpdateMgr = app.BaseClass.extend({
    // use this for initialization
    Init: function () {
        console.log('pdk_HotUpdateMgr Init');
        ...
        /// 替换该地址
        var UIRLFILE = "http://108.187.1.61:82/" + app.subGameName + "/remote-assets";
...
var g_pdk_HotUpdateMgr = null;

exports.GetModel = function(){
    if(!g_pdk_HotUpdateMgr)
        g_pdk_HotUpdateMgr = new pdk_HotUpdateMgr();
    return g_pdk_HotUpdateMgr;
