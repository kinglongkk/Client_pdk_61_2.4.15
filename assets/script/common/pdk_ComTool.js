...
var pdk_ComTool = app.BaseClass.extend({
    ...
    StringReplace:function(targetString, argList){
     ...
     //替换指定位置的字符串
    ReplacePosToStr:function(text,start,stop,replacetext){
...
exports.GetModel = function(){
    if(!g_pdk_ComTool){
        g_pdk_ComTool = new pdk_ComTool();
    }
    return g_pdk_ComTool;
}